...
public class Modelcrystal_arrow<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crystal_arrow"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition back = partdefinition.addOrReplaceChild("back",
				CubeListBuilder.create().texOffs(0, 2).addBox(-8.0F, -1.8787F, -6.1213F, 0.0F, 8.0F, 8.0F,
		...
		PartDefinition cross_1 = partdefinition.addOrReplaceChild("cross_1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-15.0F, -0.8787F, -2.1213F, 25.0F, 5.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cross_2 = partdefinition.addOrReplaceChild("cross_2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-15.0F, -5.1213F, -2.1213F, 25.0F, 5.0F, 0.0F,
						new CubeDeformation(0.0F)),
