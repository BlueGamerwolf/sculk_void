package com.blue_gamerwolf.sculkvoid.world.inventory;
...
public class SculkInvestedbarrelGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public boolean stillValid(Player player) {
		return access.evaluate((level, pos) -> level.getBlockState(pos).is(com.blue_gamerwolf.sculkvoid.init.SculkVoidModBlocks.SCULK_INVESTED_BARREL.get()), true);
	}
